...
#define RELAY_A_G1   A0
#define RELAY_A_R1   A1
#define RELAY_A_G2   A2
#define RELAY_A_R2   A3
#define RELAY_C_G1   A4
#define RELAY_C_R1   A5
#define RELAY_C_G2   A6
#define RELAY_C_R2   A7
...
const byte GREEN_CARD3[4] = {227, 209, 104, 247};
const byte RED_CARD4[4] = {227, 209, 104, 247};
const byte GREEN_CARD5[4] = {227, 102, 184, 13};
const byte RED_CARD6[4] = {211, 50, 93, 16};
